...
Weight reminders: Tue & Thu, at first meal time minus 15 min (6:45).
...
2. Inform the user about weigh-in schedule: **every Tuesday and Thursday morning, on an empty stomach (before eating)**. Explain why fasting matters: water, food, and sodium cause intra-day fluctuations — fasting gives the most consistent reading.
...
- **Tue & Thu only.** Max 2x/week. Always framed as optional.
- Always remind user to weigh **on an empty stomach** (before eating). If user has already eaten, still accept the reading but tag it internally as `fasting: false`.
...
`"Tuesday weigh-in — stepped on the scale before breakfast? If not, no worries."` ·
