...
These formulas are aligned with the diet-tracking-analysis skill to ensure consistency across the weight loss skill suite. The primary source is USDA Dietary Guidelines, adapted for weight loss contexts.
...
Fat:
  range    = totalCal × 20% ÷ 9  to  totalCal × 35% ÷ 9 g
  display  = totalCal × 27.5% ÷ 9 g (midpoint)
  calories = fat_g × 9
