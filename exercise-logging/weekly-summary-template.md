...
- **Manual trigger**: User explicitly asks for a summary at any time (e.g., "weekly summary", "how did I do this week", "how was my exercise this week")
...
Example:
- "✅ Aerobic goal met: 150 min moderate intensity (target 150 min)"
