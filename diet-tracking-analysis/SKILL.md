...
### 10. Weekly Low-Calorie Check — `weekly-low-cal-check`
...
7. **Estimate nutrition per food item** — use USDA data for each food's calories / protein g / carbs g / fat g; apply any corrections found in step 6
8. **Call save** — persist this meal (include `meal_type` with the user's original meal designation, e.g. `"breakfast"`, `"lunch"`, `"dinner"`, `"snack"`)
