...
#
# Usage: upload-to-s3.sh --file <path> --bucket <name> [--workspace <path>] [--expiry-seconds <seconds>]
#
...
with open('${WORKSPACE}/plan-url.json', 'w') as f:
    json.dump(data, f, indent=2)
" >&2
  echo "Wrote ${WORKSPACE}/plan-url.json" >&2
fi
