...
print_install_info() {
  ...
  echo "  clawhub install NanoRhino/notification-manager"
  echo "  clawhub install NanoRhino/notification-composer"
  ...
  echo "  # Copy skill folders to ~/.openclaw-user-service/skills/"
  echo "  cp -r notification-manager     ~/.openclaw-user-service/skills/"
  echo "  cp -r notification-composer    ~/.openclaw-user-service/skills/"
  echo "  cp -r diet-tracking-analysis   ~/.openclaw-user-service/skills/"
  echo "  cp -r user-onboarding-profile  ~/.openclaw-user-service/skills/"
  echo "  cp -r weight-loss-planner      ~/.openclaw-user-service/skills/"
  echo ""
  echo -e "${CYAN}Claude Code (manual):${NC}"
  echo "  # Copy skill folders to ~/.claude/skills/"
  echo "  cp -r notification-manager     ~/.claude/skills/"
  echo "  cp -r notification-composer    ~/.claude/skills/"
