...
| **P3 — Planning** | `weight-loss-planner`, `meal-planner`, `restaurant-meal-finder`, `exercise-tracking-planning` (planning mode), `habit-builder`, `weight-gain-strategy`, `weight-gain-habits` | Designing programs and plans. |
...
### Pattern 12: Weight Gain Strategy + Emotional Distress (P3 vs P1)
...
### Pattern 13: Weight Gain Strategy + Diet Logging (P3 vs P2)
...
### Pattern 14: Weight Gain Strategy + Weight-Loss Planner (Same Tier — P3)
